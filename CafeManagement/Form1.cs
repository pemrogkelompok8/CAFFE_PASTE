    ...
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
         if (txtLatte.Text != "0" || txtEspresso.Text != "0" || txtMocha.Text != "0" || txtValeCoffee.Text != "0" || txtCappu.Text != "0" || txtAfricanCoffee.Text != "0" ||
            ...
            MySqlConnection conn = new MySqlConnetion(connection);
           ...
           // rtfReceipt.AppendText(Environment.NewLine);
            rtfReceipt.AppendText("-------------------------------------------------------------" + Environment.NewLine);
            rtfReceipt.AppendText("\t\t" + "Cafe paste'" + Environment.NewLine);
            rtfReceipt.AppendText("-------------------------------------------------------------" + Environment.NewLine);
        ...
        { //btnTotal
                ...
                txtKillburnChoco.Text != "0" || txtCheeseCake.Text != "0" || txtRainbowCake.Text != "0")
            {
                ...
                lat = 12000; mocha = 12900; espr = 12900; vale = 14500; cappu = 17000; afri = 15000; mTea = 14500; cTea = 1100; //coffee pries
                cCake = 13000; rValvet = 1200; bFor = 13000; bCream = 19000; lChoco = 15000; kChoco = 14000; cheese = 13000; rain = 1100; //cake prices
        ...
        private void txtRedValvetCake_TextChanged(object sender, EventArgs e)
        {
        ...
        private void txtBlackForestCake_TextChanged(object sender, EventArgs e)
        {
        ...
        private void txtLagosChoco_TextChanged(object sender, EventArgs e)
        {

        }

        private void txtKillburnChoco_TextChanged(object sender, EventArgs e)
        {
        ...
        private void NamaAnda_TextChanged(object sender, EventArgs e)
        {
